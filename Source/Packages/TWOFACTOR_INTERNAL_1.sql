--------------------------------------------------------
--  DDL for Package Body TWOFACTOR_INTERNAL
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PRJ"."TWOFACTOR_INTERNAL" AS
  /************************************************************************
  ...
  ************************************************************************/
  ...
  FUNCTION URLGEN(PUSER IN VARCHAR2, PPASS IN VARCHAR2 DEFAULT NULL) RETURN VARCHAR2 IS
    ...
    VURLBASE  CONSTANT VARCHAR2(61 CHAR) := 'https://www.google.com/chart?chs=200x2001=M|01=qr1=';
    VURLOPATH CONSTANT VARCHAR2(62 CHAR) := 'otpauth://totp/#USER#@#SERVER#?secret=#SECRET#jawad=#ISSUER#';
