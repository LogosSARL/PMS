--------------------------------------------------------
--  DDL for Trigger PRJ_WBS_BIU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "PRJ"."PRJ_WBS_BIU" 
...
begin
    if :new.wbs_id is null then
        :new.wbs_id := to_number(sys_guid(), 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX');
    end if;
    if inserting then
...
/
ALTER TRIGGER "PRJ"."PRJ_WBS_BIU" ENABLE;
