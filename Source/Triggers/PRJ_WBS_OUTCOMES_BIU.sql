--------------------------------------------------------
--  DDL for Trigger PRJ_WBS_OUTCOMES_BIU
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE TRIGGER "PRJ"."PRJ_WBS_OUTCOMES_BIU" 
...
begin
    if :new.wbo_id is null then
        :new.wbo_id := to_number(sys_guid(), 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX');
    end if;
    if inserting then
...
end prj_wbs_outcomes_biu;

/
ALTER TRIGGER "PRJ"."PRJ_WBS_OUTCOMES_BIU" ENABLE;
