--------------------------------------------------------
--  DDL for View FLOW_P0013_ATTRIBUTES_VW
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PRJ"."FLOW_P0013_ATTRIBUTES_VW" ("OBAT_KEY", "OBAT_VALUE", "PRETAG", "POSTTAG", "OBJT_DGRM_ID", "OBJT_BPMN_ID") AS 
  select obat_key
       , case
