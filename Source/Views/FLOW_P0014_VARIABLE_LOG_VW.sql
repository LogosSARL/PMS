--------------------------------------------------------
--  DDL for View FLOW_P0014_VARIABLE_LOG_VW
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PRJ"."FLOW_P0014_VARIABLE_LOG_VW" ("LGVR_PRCS_ID", "LGVR_SBFL_ID", "LGVR_OBJT_ID", "LGVR_VAR_NAME", "LGVR_EXPR_SET", "LGVR_TIMESTAMP", "LGVR_VAR_TYPE", "LGVR_VALUE") AS 
  select lgvr_prcs_id
       , lgvr_sbfl_id
       , lgvr_objt_id
       , lgvr_var_name
