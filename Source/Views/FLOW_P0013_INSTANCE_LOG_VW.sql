--------------------------------------------------------
--  DDL for View FLOW_P0013_INSTANCE_LOG_VW
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PRJ"."FLOW_P0013_INSTANCE_LOG_VW" ("LGPR_PRCS_ID", "LGPR_OBJT_ID", "LGPR_PRCS_NAME", "LGPR_BUSINESS_ID", "LGPR_PRCS_EVENT", "LGPR_PRCS_EVENT_ICON", "LGPR_TIMESTAMP", "LGPR_USER", "LGPR_COMMENT", "LGPR_ERROR_INFO", "PRETAG", "POSTTAG") AS 
