--------------------------------------------------------
--  DDL for View FLOW_SUBFLOWS_VW
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PRJ"."FLOW_SUBFLOWS_VW" ("SBFL_ID", "SBFL_SBFL_ID", "SBFL_PRCS_ID", "SBFL_PROCESS_NAME", "SBFL_DGRM_ID", "SBFL_SBFL_DGRM_ID", "SBFL_DGRM_NAME", "SBFL_DGRM_VERSION", "SBFL_DGRM_STATUS", "SBFL_DGRM_CATEGORY", "SBFL_STARTING_OBJECT", "SBFL_STARTING_OBJECT_NAME", "SBFL_ROUTE", "SBFL_ROUTE_NAME", "SBFL_LAST_COMPLETED", "SBFL_LAST_COMPLETED_NAME", "SBFL_CURRENT", "SBFL_CURRENT_NAME", "SBFL_STEP_KEY", "SBFL_CURRENT_TAG_NAME", "SBFL_LAST_UPDATE", "SBFL_STATUS", "SBFL_CURRENT_LANE", "SBFL_CURRENT_LANE_NAME", "SBFL_PROCESS_LEVEL", "SBFL_RESERVATION", "SBFL_CURRENT_OBJT_ID", "SBFL_PRCS_INIT_TS", "TIMR_START_ON") AS 
  select sbfl.sbfl_id
        , sbfl.sbfl_sbfl_id
        , sbfl.sbfl_prcs_id
