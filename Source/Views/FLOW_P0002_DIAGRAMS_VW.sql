--------------------------------------------------------
--  DDL for View FLOW_P0002_DIAGRAMS_VW
--------------------------------------------------------

  CREATE OR REPLACE FORCE EDITIONABLE VIEW "PRJ"."FLOW_P0002_DIAGRAMS_VW" ("DGRM_ID", "DGRM_NAME", "DGRM_VERSION", "DGRM_STATUS", "DGRM_CATEGORY", "DGRM_LAST_UPDATE", "BTN", "EDIT_LINK", "CREATE_INSTANCE_LINK", "INSTANCES", "DIAGRAM_PARSED", "DIAGRAM_PARSED_ICON", "DGRM_STATUS_ICON", "INSTANCE_CREATED", "INSTANCE_CREATED_LINK", "INSTANCE_RUNNING", "INSTANCE_RUNNING_LINK", "INSTANCE_COMPLETED", "INSTANCE_COMPLETED_LINK", "INSTANCE_TERMINATED", "INSTANCE_TERMINATED_LINK", "INSTANCE_ERROR", "INSTANCE_ERROR_LINK", "CHECKBOX") AS 
