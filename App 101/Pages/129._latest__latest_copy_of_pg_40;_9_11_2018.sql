...
begin
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>129);
end;
/
...
,p_step_sub_title=>'latest  latest copy of pg 40; 9/11/2018'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(268568233540523253)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266510529163321489)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266508986383321487)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266509386152321489)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266509744301321489)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266510178824321489)
,p_query_column_id=>5
,p_column_alias=>'SAL'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(268570678485523258)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266511104900321492)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266511578168321492)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266511910256321493)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266512398926321493)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266512739477321493)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266513125655321493)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266513549607321493)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266513968439321493)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266514398999321493)
,p_query_column_id=>9
,p_column_alias=>'QTY'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266514763182321494)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266515139000321494)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266515523858321494)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266515941232321494)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266516395670321494)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266516781000321494)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266517104908321494)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266517502844321495)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266517965586321495)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266518359219321495)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(268579887755523280)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266520242108321499)
,p_query_column_id=>1
,p_column_alias=>'EMP_NAME'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266520612946321499)
,p_query_column_id=>2
,p_column_alias=>'INHOUSE'
,p_column_display_sequence=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266521046686321499)
,p_query_column_id=>3
,p_column_alias=>'ONSITE'
,p_column_display_sequence=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266521403818321499)
,p_query_column_id=>4
,p_column_alias=>'TOTAL'
,p_column_display_sequence=>4
,p_column_heading=>'Total'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266521825624321499)
,p_query_column_id=>5
,p_column_alias=>'SAL'
,p_column_display_sequence=>5
,p_column_heading=>'Sal'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(268582226947523286)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266522599641321500)
,p_query_column_id=>1
,p_column_alias=>'MODULE'
,p_column_display_sequence=>1
,p_column_heading=>'Module'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266522996296321500)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266523347438321500)
,p_query_column_id=>3
,p_column_alias=>'ESTIMATED'
,p_column_display_sequence=>3
,p_column_heading=>'Est.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266523788869321500)
,p_query_column_id=>4
,p_column_alias=>'ENROLLMENT'
,p_column_display_sequence=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266524127593321500)
,p_query_column_id=>5
,p_column_alias=>'NET'
,p_column_display_sequence=>5
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(268956891918190614)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(453843499848504899)
,p_plug_name=>'Search a Contract'
,p_parent_plug_id=>wwv_flow_api.id(268956891918190614)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20903049949019134)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(268549218493523153)
,p_name=>'Contracts'
,p_parent_plug_id=>wwv_flow_api.id(453843499848504899)
,p_template=>wwv_flow_api.id(20903049949019134)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266531059402321505)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266541833820321511)
,p_query_column_id=>2
,p_column_alias=>'CSS'
,p_column_display_sequence=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266531428907321505)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266531807665321505)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266532253407321505)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266532603102321505)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266533087895321505)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266533443803321506)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266533858107321506)
,p_query_column_id=>9
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266534207071321506)
,p_query_column_id=>10
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266534668714321506)
,p_query_column_id=>11
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266535045710321507)
,p_query_column_id=>12
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266535443935321507)
,p_query_column_id=>13
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266535820693321507)
,p_query_column_id=>14
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266536215801321508)
,p_query_column_id=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266536630585321508)
,p_query_column_id=>16
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266537088371321508)
,p_query_column_id=>17
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266537401169321508)
,p_query_column_id=>18
,p_column_alias=>'ENR'
,p_column_display_sequence=>17
,p_column_heading=>'Enr'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266537899157321509)
,p_query_column_id=>19
,p_column_alias=>'EST'
,p_column_display_sequence=>15
,p_column_heading=>'Est'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266538265798321509)
...
begin
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266538662122321509)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266539060678321509)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266539428954321510)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266539826162321510)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266540269969321510)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266540609530321511)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266541081974321511)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266541451148321511)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266542233488321512)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(529021267510288780)
,p_plug_name=>'h89'
,p_parent_plug_id=>wwv_flow_api.id(453843499848504899)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(268558245090523236)
,p_name=>'Projects of  &P129_CONTRACT_DESC.'
,p_parent_plug_id=>wwv_flow_api.id(529021267510288780)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266552422527321518)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'Edit'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266552877601321518)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266553222368321518)
,p_query_column_id=>3
,p_column_alias=>'DSP_CODE'
,p_column_display_sequence=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266553615042321519)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266554006740321519)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266554485388321519)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266554818714321520)
,p_query_column_id=>7
,p_column_alias=>'APPROVAL_DATE'
,p_column_display_sequence=>18
,p_column_heading=>'Approval Date'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266555209882321520)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266555678595321520)
,p_query_column_id=>9
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266548858258321516)
,p_query_column_id=>10
,p_column_alias=>'MODULE'
,p_column_display_sequence=>10
,p_column_heading=>'Module'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266556444139321520)
,p_query_column_id=>11
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266556879077321521)
,p_query_column_id=>12
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266549239564321516)
,p_query_column_id=>13
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266549660017321516)
,p_query_column_id=>14
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266556051016321520)
,p_query_column_id=>15
,p_column_alias=>'STATUS'
,p_column_display_sequence=>23
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266550058228321516)
,p_query_column_id=>16
,p_column_alias=>'SEQ'
,p_column_display_sequence=>2
,p_column_heading=>'Seq'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266550475507321517)
,p_query_column_id=>17
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266550836761321517)
,p_query_column_id=>18
,p_column_alias=>'WORK'
,p_column_display_sequence=>14
,p_column_heading=>'Enr.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266551291576321517)
,p_query_column_id=>19
,p_column_alias=>'EXPENCES'
,p_column_display_sequence=>15
,p_column_heading=>'Net'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266551655272321517)
,p_query_column_id=>20
,p_column_alias=>'EXP'
,p_column_display_sequence=>16
,p_hidden_column=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266552072665321517)
,p_query_column_id=>21
,p_column_alias=>'EMP'
,p_column_display_sequence=>17
,p_hidden_column=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266557281889321521)
,p_query_column_id=>22
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266557620344321521)
,p_query_column_id=>23
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(266542638682321512)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(268549218493523153)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(266546504086321513)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(529021267510288780)
,p_button_name=>'go'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(266527133939321502)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(453843499848504899)
,p_button_name=>'GO'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(20901145090019119)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(266546975698321513)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(266543064997321512)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(268549218493523153)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(266558093716321521)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(268558245090523236)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(20901145090019119)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(266518717991321495)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(268570678485523258)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(266519196623321496)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(268570678485523258)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(266564149076321529)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266519539143321496)
,p_name=>'P129_ZERO'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(268570678485523258)
,p_item_default=>'0'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266524838948321501)
,p_name=>'P129_VIEW'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(268956891918190614)
,p_item_default=>'non'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266525234303321501)
,p_name=>'P129_CNTIDD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(268956891918190614)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266525611887321501)
,p_name=>'P129_PCI'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(268956891918190614)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266526033119321501)
,p_name=>'P129_CID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(268956891918190614)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266526468126321501)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266527507232321502)
,p_name=>'P129_COMPANYNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(453843499848504899)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266527967517321502)
,p_name=>'P129_STATUS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(453843499848504899)
,p_prompt=>'Status'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266528336905321503)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266528768554321503)
,p_name=>'P129_VIEW_1'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(453843499848504899)
,p_item_default=>'non'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266529129174321503)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266529538057321503)
,p_name=>'P129_PCI_1'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(453843499848504899)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266529918641321504)
,p_name=>'P129_CID_1'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(453843499848504899)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266530377874321504)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266543412474321512)
,p_name=>'P129_CONTRACT_ID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(268549218493523153)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266543840170321512)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266544284507321512)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266544626929321513)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266545023715321513)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266545444522321513)
,p_name=>'P129_LCDID'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(268549218493523153)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266545861611321513)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266547329909321514)
,p_name=>'P129_MODULE_SEARCH'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(529021267510288780)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266547735281321514)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266548108206321514)
,p_name=>'P129_DATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(529021267510288780)
,p_prompt=>'Date'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266558402992321522)
,p_name=>'P129_SHOW_WHAT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(268558245090523236)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266558824132321522)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266559269337321522)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(266560858510321525)
,p_name=>'New'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(266561333711321526)
,p_event_id=>wwv_flow_api.id(266560858510321525)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(266561853225321527)
,p_event_id=>wwv_flow_api.id(266560858510321525)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(266562282053321527)
,p_name=>'New_1'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(266558093716321521)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(266562705460321527)
,p_event_id=>wwv_flow_api.id(266562282053321527)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(266563151122321527)
,p_name=>'loading'
,p_event_sequence=>30
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(266563682161321528)
,p_event_id=>wwv_flow_api.id(266563151122321527)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(266560069466321525)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(266559626619321525)
,p_process_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(266560436603321525)
,p_process_sequence=>10
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(266546975698321513)
