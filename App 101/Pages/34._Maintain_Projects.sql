...
,p_step_sub_title=>'Maintain Projects'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2381864198990207)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2382231197990217)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(2381864198990207)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2382609045990232)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2383040982990233)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2383412072990233)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2396800001990300)
,p_branch_name=>'Go To Page 5'
,p_branch_action=>'f?p=&APP_ID.:5:&SESSION.&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(2383412072990233)
,p_branch_sequence=>1
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2383842417990235)
,p_name=>'P34_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(2381864198990207)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2384215100990247)
,p_name=>'P34_SEQ'
,p_item_sequence=>11
,p_item_plug_id=>wwv_flow_api.id(2381864198990207)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2384649733990247)
,p_name=>'P34_SEARCH'
,p_item_sequence=>21
,p_item_plug_id=>wwv_flow_api.id(2381864198990207)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2385014924990248)
,p_name=>'P34_MODULE'
,p_is_required=>true
,p_item_sequence=>31
,p_item_plug_id=>wwv_flow_api.id(2381864198990207)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2385415089990249)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2385835840990250)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2386293438990251)
,p_name=>'P34_END_DATE'
,p_item_sequence=>61
,p_item_plug_id=>wwv_flow_api.id(2381864198990207)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2386633614990253)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2387034678990253)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2387490063990254)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2387829881990254)
,p_name=>'P34_ACTIVE'
,p_item_sequence=>101
,p_item_plug_id=>wwv_flow_api.id(2381864198990207)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2388245289990255)
,p_name=>'P34_DSP_CODE'
,p_item_sequence=>111
,p_item_plug_id=>wwv_flow_api.id(2381864198990207)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2388621404990255)
,p_name=>'P34_INT_CODE'
,p_is_required=>true
,p_item_sequence=>121
,p_item_plug_id=>wwv_flow_api.id(2381864198990207)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2389010040990256)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2389443001990257)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2389832631990258)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2390253614990258)
,p_name=>'P34_NEW'
,p_item_sequence=>161
,p_item_plug_id=>wwv_flow_api.id(2381864198990207)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2390674861990259)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2391085559990260)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(2394306771990295)
,p_name=>'New'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(2395349182990296)
,p_event_id=>wwv_flow_api.id(2394306771990295)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(2395853436990297)
,p_event_id=>wwv_flow_api.id(2394306771990295)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(2396372427990298)
,p_event_id=>wwv_flow_api.id(2394306771990295)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(2394899364990296)
,p_event_id=>wwv_flow_api.id(2394306771990295)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(2392953788990289)
,p_name=>'New_1'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(2393946493990293)
,p_event_id=>wwv_flow_api.id(2392953788990289)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(2393483446990292)
,p_event_id=>wwv_flow_api.id(2392953788990289)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2391412448990282)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2391767388990288)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2392135977990288)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_process_when_button_id=>wwv_flow_api.id(2383412072990233)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2392502297990289)
