...
,p_name=>'Download BLOB File'
,p_page_mode=>'NORMAL'
,p_step_title=>'Download BLOB File'
...
,p_last_upd_yyyymmddhh24miss=>'20170328090519'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(90138594638650604)
,p_plug_name=>'New'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(90138632493650605)
,p_name=>'P43_FILE_NAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(90138594638650604)
