...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(213228687384192285)
,p_plug_name=>'New'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(213131817082367475)
,p_plug_name=>'Report'
,p_parent_plug_id=>wwv_flow_api.id(213228687384192285)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20903049949019134)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(213131882235367475)
,p_name=>'Report'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(110447472616900446)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(110447877987900447)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(102786301459291922)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(213244610570366952)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(110444441453900421)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(213228687384192285)
,p_button_name=>'GO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(110445251929900432)
,p_name=>'P95_MONTH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(213228687384192285)
,p_prompt=>'Month'
