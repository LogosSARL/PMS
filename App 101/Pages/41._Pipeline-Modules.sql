...
,p_last_upd_yyyymmddhh24miss=>'20220902110830'
);
...
'if :USER_ROLE like ''%ACCOUNT_MANAGER%'' then :P41_ROLE :=  ''AccountManager_ChangeRequest:23:62548''; ',
'elsif :USER_ROLE LIKE ''%PROJECT_MANAGER%'' then :P41_ROLE :=  ''AccountManager_ChangeRequest:23:62548'';',
