...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(190744943935994001)
,p_plug_name=>'New'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(190745053204994002)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(190744943935994001)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(190842162276190502)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(190842368766190504)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(190842574368190506)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190842006014190501)
,p_name=>'P108_RESPONSE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(190744943935994001)
,p_prompt=>'Response: '
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190842709690190508)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(190730501963451501)
...
,p_process_when_button_id=>wwv_flow_api.id(190745053204994002)
,p_process_success_message=>'success apex message'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(190842281123190503)
...
' END;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(190842162276190502)
,p_process_success_message=>'success list task'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(190842479156190505)
...
'END;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(190842368766190504)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(190842652466190507)
...
' END;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(190842574368190506)
);
end;
/
begin
