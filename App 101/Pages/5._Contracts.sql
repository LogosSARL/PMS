...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(15715002886841865)
,p_name=>'Contracts'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15715301579841876)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1987097411255412)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15715391983841881)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15715519690841881)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15715594879841881)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1668801688196367)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1668904707196370)
,p_query_column_id=>7
,p_column_alias=>'ENR'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1669018137196370)
,p_query_column_id=>8
,p_column_alias=>'EST'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1669104200196370)
,p_query_column_id=>9
,p_column_alias=>'NET'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1671912657341520)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(1672019464341520)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5099802766400488)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(5100617714575799)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15790604803424542)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15791706908002405)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(13032686529273253)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(15725194251922886)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15725514558922908)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'Edit'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15725616474922914)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15725701554922914)
,p_query_column_id=>3
,p_column_alias=>'DSP_CODE'
,p_column_display_sequence=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15725795834922914)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15725899428922914)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15726018175922914)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15726109822922914)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15726197035922914)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15726318566922914)
,p_query_column_id=>9
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15726411968922914)
,p_query_column_id=>10
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15726490952922914)
,p_query_column_id=>11
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15726607679922914)
,p_query_column_id=>12
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15726713424922914)
,p_query_column_id=>13
,p_column_alias=>'SEQ'
,p_column_display_sequence=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15727104067935324)
,p_query_column_id=>14
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15727209387935326)
,p_query_column_id=>15
,p_column_alias=>'WORK'
,p_column_display_sequence=>15
,p_column_heading=>'Enr.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15727307660935326)
,p_query_column_id=>16
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15727396917935326)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15727502876935326)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15727599298935326)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15727695113935326)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(15729409974088462)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15729706892088469)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15729808503088469)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15729891454088469)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15729991733088469)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15787211902252782)
,p_query_column_id=>5
,p_column_alias=>'SAL'
,p_column_display_sequence=>5
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(15731292284206301)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15731614773206310)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15731690573206310)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15731794481206310)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15731896977206310)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15732019246206310)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15732113236206310)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15732216544206310)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15732320073206310)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15732418304206310)
,p_query_column_id=>9
,p_column_alias=>'QTY'
,p_column_display_sequence=>11
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15732502810206310)
,p_query_column_id=>10
,p_column_alias=>'SEQ'
,p_column_display_sequence=>2
,p_column_heading=>'Seq'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15732606915206310)
,p_query_column_id=>11
,p_column_alias=>'EST'
,p_column_display_sequence=>13
,p_column_heading=>'Est.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15732716189206310)
,p_query_column_id=>12
,p_column_alias=>'WORK'
,p_column_display_sequence=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15732821997206310)
,p_query_column_id=>13
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15732912389206310)
,p_query_column_id=>14
...
begin
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15733010253206310)
,p_query_column_id=>15
,p_column_alias=>'EXP'
,p_column_display_sequence=>16
,p_column_heading=>'EXP'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15733114662206310)
,p_query_column_id=>16
,p_column_alias=>'EXPENCES'
,p_column_display_sequence=>17
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15733196939206310)
,p_query_column_id=>17
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15733310510206310)
,p_query_column_id=>18
,p_column_alias=>'MODULE'
,p_column_display_sequence=>19
,p_column_heading=>'MODULE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15733420941206310)
,p_query_column_id=>19
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(15787516777831376)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15787807825831401)
,p_query_column_id=>1
,p_column_alias=>'EMP_NAME'
,p_column_display_sequence=>1
,p_column_heading=>'Staff'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15787894314831401)
,p_query_column_id=>2
,p_column_alias=>'INHOUSE'
,p_column_display_sequence=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15788004044831401)
,p_query_column_id=>3
,p_column_alias=>'ONSITE'
,p_column_display_sequence=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15788104106831401)
,p_query_column_id=>4
,p_column_alias=>'TOTAL'
,p_column_display_sequence=>4
,p_column_heading=>'Total'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15788207205831401)
,p_query_column_id=>5
,p_column_alias=>'SAL'
,p_column_display_sequence=>5
,p_column_heading=>'Sal'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(15790811971994424)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15791107608994460)
,p_query_column_id=>1
,p_column_alias=>'MODULE'
,p_column_display_sequence=>1
,p_column_heading=>'Module'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15791200970994462)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15791314253994462)
,p_query_column_id=>3
,p_column_alias=>'ESTIMATED'
,p_column_display_sequence=>3
,p_column_heading=>'Est.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15791414418994462)
,p_query_column_id=>4
,p_column_alias=>'ENROLLMENT'
,p_column_display_sequence=>4
,p_column_heading=>'Enr.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15791504058994462)
,p_query_column_id=>5
,p_column_alias=>'NET'
,p_column_display_sequence=>5
,p_column_heading=>'Net'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15715818479841882)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(15715002886841865)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15726903254922914)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(15725194251922886)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(20901145090019119)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14436088791280163)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(15731292284206301)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14437084054486942)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(15718407510998969)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14436472430294353)
,p_name=>'P5_ZERO'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(15731292284206301)
,p_item_default=>'0'
,p_prompt=>'Zero'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15717907117970447)
,p_name=>'P5_COMPANY'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(15715002886841865)
,p_prompt=>'Company'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15718205648988963)
,p_name=>'P5_FINALIZED'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(15715002886841865)
...
,p_lov=>'.'||wwv_flow_api.id(3247017916192489)||'.'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cHeight=>1
,p_cAttributes=>'nowrap="nowrap"'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15728007315945734)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15728217011948515)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15730192097092765)
,p_name=>'P5_CURRENT_PROJECT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(15725194251922886)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15730707512135007)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15731009552182919)
,p_name=>'P5_SHOW_WHAT'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(15725194251922886)
,p_prompt=>'Show What'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15802214289091135)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15765197577105669)
