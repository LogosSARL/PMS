...
,p_step_sub_title=>'Contracts - Jawad version'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(264518280534117378)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(262529726079105604)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262529897640105605)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262529937876105606)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262530026822105607)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262530158390105608)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262530226084105609)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(262712743638968776)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(264520725479117383)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(262530315878105610)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262530401229105611)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262531388553105620)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262530580969105612)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262530606429105613)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262530722408105614)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262530862497105615)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262530982874105616)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262531020782105617)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262531148839105618)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262531218289105619)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262531441402105621)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262531560509105622)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262531683793105623)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262531739757105624)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262531858714105625)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262531914530105626)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262532077874105627)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262532101601105628)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262532282220105629)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(262713356140968776)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(264529934749117405)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(262532306966105630)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262532447845105631)
,p_db_column_name=>'EMP_NAME'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Emp name'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262532578844105632)
,p_db_column_name=>'INHOUSE'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Inhouse'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262532692889105633)
,p_db_column_name=>'ONSITE'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Onsite'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262532789159105634)
,p_db_column_name=>'TOTAL'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Total'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262532847543105635)
,p_db_column_name=>'SAL'
,p_display_order=>50
,p_column_identifier=>'E'
,p_column_label=>'Sal'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(262713900479968776)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(264532273941117411)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(262532970366105636)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262533043763105637)
,p_db_column_name=>'MODULE'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Module'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262533108090105638)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262533233944105639)
,p_db_column_name=>'ESTIMATED'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Estimated'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262533309725105640)
,p_db_column_name=>'ENROLLMENT'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Enrollment'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262533482122105641)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(262714510407968777)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(264906938911784739)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20903049949019134)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(264508292084117361)
,p_plug_name=>'Projects of  &P121_CONTRACT_DESC.'
,p_parent_plug_id=>wwv_flow_api.id(264906938911784739)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(13004471707590532)
,p_plug_display_sequence=>30
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(262527458616098831)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262527514317098832)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262528944805098846)
,p_db_column_name=>'SEQ'
,p_display_order=>20
,p_column_identifier=>'O'
,p_column_label=>'Seq'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262527633117098833)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262527722587098834)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262527855160098835)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262527955789098836)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262528039393098837)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262528153738098838)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262528231693098839)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262528312338098840)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262528403279098841)
,p_db_column_name=>'MODULE'
,p_display_order=>110
,p_column_identifier=>'J'
,p_column_label=>'Module'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262528563435098842)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262528656781098843)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262528794818098844)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262528861197098845)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262529093479098847)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262529173848098848)
,p_db_column_name=>'WORK'
,p_display_order=>170
,p_column_identifier=>'Q'
,p_column_label=>'Work'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262529250419098849)
,p_db_column_name=>'EXPENCES'
,p_display_order=>180
,p_column_identifier=>'R'
,p_column_label=>'Expences'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262529351711098850)
,p_db_column_name=>'EXP'
,p_display_order=>190
,p_column_identifier=>'S'
,p_column_label=>'Exp'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262529488811105601)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262529544526105602)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262529608462105603)
...
begin
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(262712236978968774)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(449793546842099024)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(264499265487117278)
,p_plug_name=>'Contracts'
,p_parent_plug_id=>wwv_flow_api.id(449793546842099024)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(20903049949019134)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(262524412626098801)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262524574490098802)
,p_db_column_name=>'ID'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Edit'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262524696687098803)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262525394504098810)
,p_db_column_name=>'DSP_CODE'
,p_display_order=>30
,p_column_identifier=>'I'
,p_column_label=>'Dsp code'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262525771400098814)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262526150549098818)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262525184509098808)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262525231295098809)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262526793079098824)
,p_db_column_name=>'PM'
,p_display_order=>90
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262526897301098825)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262527268779098829)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262525952776098816)
...
,p_column_type=>'STRING'
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_rpt_named_lov=>wwv_flow_api.id(20935140090118790)
,p_rpt_show_filter_lov=>'1'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262526903449098826)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262527095372098827)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262527177387098828)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262526311952098820)
,p_db_column_name=>'EST'
,p_display_order=>160
,p_column_identifier=>'S'
,p_column_label=>'Est'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262524719511098804)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262526255576098819)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262526470198098821)
,p_db_column_name=>'NET'
,p_display_order=>190
,p_column_identifier=>'T'
,p_column_label=>'Net'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262526593864098822)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262526698418098823)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262526025844098817)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262524910337098806)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262524843179098805)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262525400745098811)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262525531186098812)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262525650155098813)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262525895872098815)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262525035193098807)
,p_db_column_name=>'APPROVAL_DATE'
,p_display_order=>300
,p_column_identifier=>'F'
,p_column_label=>'Approval date'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(262527333403098830)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(262590721445119547)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(262503490090915633)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(264499265487117278)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(262487934132915628)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(449793546842099024)
,p_button_name=>'GO'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(262503835808915634)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(262486016014915627)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(264508292084117361)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(20901145090019119)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(262468822006915619)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(264520725479117383)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(262469243577915619)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(262511187986915637)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262469632926915619)
,p_name=>'P121_ZERO'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(264520725479117383)
,p_item_default=>'0'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262474977918915623)
,p_name=>'P121_VIEW'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(264906938911784739)
,p_item_default=>'non'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262475357852915623)
,p_name=>'P121_CNTIDD'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(264906938911784739)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262475748419915623)
,p_name=>'P121_PCI'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(264906938911784739)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262476162922915623)
,p_name=>'P121_CID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(264906938911784739)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262476519317915624)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262486425162915627)
,p_name=>'P121_SHOW_WHAT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(264508292084117361)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262486868354915627)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262487297515915627)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262488383424915628)
,p_name=>'P121_COMPANYNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(449793546842099024)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262488766676915628)
,p_name=>'P121_STATUS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(449793546842099024)
,p_prompt=>'Status'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262489185688915628)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262489521598915629)
,p_name=>'P121_VIEW_1'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(449793546842099024)
,p_item_default=>'non'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262489935311915629)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262490343528915629)
,p_name=>'P121_PCI_1'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(449793546842099024)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262490724559915629)
,p_name=>'P121_CID_1'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(449793546842099024)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262491189036915629)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262504212638915634)
,p_name=>'P121_CONTRACT_ID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(264499265487117278)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262504672359915634)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262505009467915634)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262505468216915634)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262505847330915634)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262506236546915634)
,p_name=>'P121_LCDID'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(264499265487117278)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262506679055915634)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(262507874107915636)
,p_name=>'New'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(262503490090915633)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(262508333286915636)
,p_event_id=>wwv_flow_api.id(262507874107915636)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(262508896018915636)
,p_event_id=>wwv_flow_api.id(262507874107915636)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(262509222434915637)
,p_name=>'New_1'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(262509745119915637)
,p_event_id=>wwv_flow_api.id(262509222434915637)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(262510109450915637)
,p_name=>'loading'
,p_event_sequence=>30
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(262510646171915637)
,p_event_id=>wwv_flow_api.id(262510109450915637)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(262507467449915636)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(262507099646915635)
,p_process_sequence=>10
