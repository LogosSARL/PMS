...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15709212529841736)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(15824599949102738)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15824910448102744)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15825014943102746)
,p_query_column_id=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(228841100372313999)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(229881009813140034)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15825610516143638)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(15824599949102738)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15709507529841748)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(15709212529841736)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15709808739841768)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15709415237841748)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15709616052841748)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(15710297458841798)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14440681746133157)
,p_name=>'P8_WHO_CREATED'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(15709212529841736)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15710498223841804)
,p_name=>'P8_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(15709212529841736)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15710698686841834)
,p_name=>'P8_DSP_CODE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(15709212529841736)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15710913705841837)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15711098364841839)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15711306898841845)
,p_name=>'P8_END_DATE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(15709212529841736)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15711692586841846)
,p_name=>'P8_FINALIZED'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(15709212529841736)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15711909546841848)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15712112577841848)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(72608730312718802)
,p_name=>'P8_INVOICED_DAYS'
,p_item_sequence=>230
,p_item_plug_id=>wwv_flow_api.id(228841100372313999)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(182544543727767143)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(182544632756767144)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(182544766132767145)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(182544801616767146)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(182544924953767147)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(182545003849767148)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(182545161207767149)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(182545207088767150)
,p_name=>'P8_INSCOPE'
,p_item_sequence=>290
,p_item_plug_id=>wwv_flow_api.id(15709212529841736)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227007779951195101)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227019706843456921)
,p_name=>'P8_PRICING_DATE_1'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(229881009813140034)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227020162517456926)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227020504260456926)
,p_name=>'P8_REF_PM'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(229881009813140034)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227020939438456927)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227021311513456929)
,p_name=>'P8_REFERENCE'
,p_item_sequence=>180
,p_item_plug_id=>wwv_flow_api.id(229881009813140034)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227021798277456929)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227022192975456930)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227024433538459352)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227024853678459353)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227025264124459354)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227025602182459354)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227026027503459355)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227026457564459355)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227026840095459356)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227027231357459356)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227027631337459364)
,p_name=>'P8_VAT_VALUE'
,p_item_sequence=>300
,p_item_plug_id=>wwv_flow_api.id(228841100372313999)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227028024608459364)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227028493175459365)
,p_name=>'P8_LL_VALUE'
,p_item_sequence=>320
,p_item_plug_id=>wwv_flow_api.id(228841100372313999)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227028829143459365)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227029294777459366)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227029652575459366)
...
begin
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227030092969459367)
,p_name=>'P8_PERDIUM_1'
,p_item_sequence=>360
,p_item_plug_id=>wwv_flow_api.id(228841100372313999)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227030486803459368)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227030847729459368)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227031264244459369)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227031664976459370)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227032019884459370)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227032447717459371)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227032845809459371)
,p_name=>'P8_REMARKS'
,p_item_sequence=>430
,p_item_plug_id=>wwv_flow_api.id(228841100372313999)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227033254551459372)
,p_name=>'P8_SIGNED_BY'
,p_item_sequence=>440
,p_item_plug_id=>wwv_flow_api.id(228841100372313999)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227033677794459372)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227034086341459373)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(227034476230459374)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2720448055162024)
...
,p_associated_item=>wwv_flow_api.id(15711098364841839)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(2720508228162025)
...
,p_validation_condition=>'1=0'
,p_validation_condition_type=>'PLSQL_EXPRESSION'
,p_associated_item=>wwv_flow_api.id(15711306898841845)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15713991475841857)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15714203949841864)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15714391544841864)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_process_when_button_id=>wwv_flow_api.id(15709616052841748)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15761612421766929)
...
'END;'))
,p_process_when_button_id=>wwv_flow_api.id(15709415237841748)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(27088152020379528)
