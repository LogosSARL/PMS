...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(19252368359023745)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(19252859312023746)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(19252368359023745)
,p_button_name=>'SAVE'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(19253069275023747)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(19252726168023746)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(19252946551023746)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(19057461064394740)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19056645779394732)
,p_name=>'P78_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(19252368359023745)
,p_prompt=>'Search'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19254602375023752)
,p_name=>'P78_ID'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(19252368359023745)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19254902673023766)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19255349520023769)
,p_name=>'P78_DSP_CODE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(19252368359023745)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19255794489023770)
,p_name=>'P78_END_DATE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(19252368359023745)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19256199244023771)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19256520128023772)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19256953376023773)
,p_name=>'P78_INT_CODE'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(19252368359023745)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19257365033023773)
,p_name=>'P78_MODULE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(19252368359023745)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19257758747023774)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19258136603023775)
,p_name=>'P78_ACTIVE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(19252368359023745)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19258586900023775)
,p_name=>'P78_SEQ'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(19252368359023745)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19258931229023776)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19259327241023776)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(19259786679023777)
,p_name=>'P78_STATUS'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(19252368359023745)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(19056866141394734)
,p_name=>'New'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(19056998917394735)
,p_event_id=>wwv_flow_api.id(19056866141394734)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(19057084535394736)
,p_event_id=>wwv_flow_api.id(19056866141394734)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(19057157590394737)
,p_name=>'New_1'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(19057269710394738)
,p_event_id=>wwv_flow_api.id(19057157590394737)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(19262339040023783)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(19262717876023783)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(19263131807023785)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(19252946551023746)
);
end;
/
begin
