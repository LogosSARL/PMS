...
,p_last_upd_yyyymmddhh24miss=>'20220902130837'
);
...
,p_item_plug_id=>wwv_flow_imp.id(19252368359023745)
,p_use_cache_before_default=>'NO'
,p_item_default=>'select end_date from lgs_contracts where id = :p78_contract_id and :p78_id is null;'
...
,p_item_plug_id=>wwv_flow_imp.id(19252368359023745)
,p_use_cache_before_default=>'NO'
,p_item_default=>'select start_date from lgs_contracts where id = :p78_contract_id and :p78_id is null;'
,p_item_default_type=>'SQL_QUERY'
,p_prompt=>'Start Date'
,p_source=>'START_DATE'
,p_source_type=>'DB_COLUMN'
