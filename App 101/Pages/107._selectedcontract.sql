...
begin
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>107);
end;
/
...
,p_step_sub_title=>'selectedcontract'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(148575208229075935)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(148594561516123001)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(148594683250123002)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(148594786448123003)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(148594841184123004)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(148594990495123005)
,p_query_column_id=>5
,p_column_alias=>'SAL'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(148595123265123007)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(148575208229075935)
,p_button_name=>'Back'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(148595014440123006)
,p_name=>'P107_CONTRACT_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(148575208229075935)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(148595244082123008)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(148595363347123009)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(148595412605123010)
