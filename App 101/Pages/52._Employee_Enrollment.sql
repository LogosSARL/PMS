...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(182543548801767133)
,p_name=>'New'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(182543694471767134)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(182543786462767135)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(182543876207767136)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(182543923905767137)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(182544040496767138)
,p_query_column_id=>5
,p_column_alias=>'SAL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(182544153595767139)
,p_name=>'P52_PROJECT_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(182543548801767133)
,p_item_default=>'4205'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(182544260480767140)
