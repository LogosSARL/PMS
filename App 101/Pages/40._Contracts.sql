...
,p_last_upd_yyyymmddhh24miss=>'20220812123752'
);
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2060014633201777)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2060415049201779)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2060822174201780)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2061206703201780)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2061654923201781)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2062022169201781)
,p_query_column_id=>5
,p_column_alias=>'SAL'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2062459578201782)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2062840928201783)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
,p_column_heading=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2063205998201784)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2063638762201784)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2064093806201785)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2064425591201785)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2064887013201786)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2065230412201789)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2065600140201790)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2066054200201790)
,p_query_column_id=>9
,p_column_alias=>'QTY'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2066439413201791)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2066803388201791)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2067216089201792)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2067642816201796)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(432912314211306231)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2068014071201796)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2068440439201797)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2068896646201797)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2069215183201798)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2069643463201801)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2070056938201802)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2071668848201804)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2072003091201807)
,p_query_column_id=>1
,p_column_alias=>'EMP_NAME'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2072492201201807)
,p_query_column_id=>2
,p_column_alias=>'INHOUSE'
,p_column_display_sequence=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2072817278201808)
,p_query_column_id=>3
,p_column_alias=>'ONSITE'
,p_column_display_sequence=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2073256609201808)
,p_query_column_id=>4
,p_column_alias=>'TOTAL'
,p_column_display_sequence=>4
,p_column_heading=>'Total'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2073639967201809)
,p_query_column_id=>5
,p_column_alias=>'SAL'
,p_column_display_sequence=>5
,p_column_heading=>'Sal'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2074008040201810)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2074423796201810)
,p_query_column_id=>1
,p_column_alias=>'MODULE'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2074883027201811)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2075251626201812)
,p_query_column_id=>3
,p_column_alias=>'ESTIMATED'
,p_column_display_sequence=>3
,p_column_heading=>'Est.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(432912426498306232)
,p_query_column_id=>4
,p_column_alias=>'REMAINING'
,p_column_display_sequence=>6
,p_column_heading=>'Remaining'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2075689055201812)
,p_query_column_id=>5
,p_column_alias=>'ENROLLMENT'
,p_column_display_sequence=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2076000019201813)
,p_query_column_id=>6
,p_column_alias=>'NET'
,p_column_display_sequence=>5
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(187335280941183423)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2040999586201677)
,p_name=>'Contracts'
,p_region_name=>'contracts'
,p_parent_plug_id=>wwv_flow_api.id(187335280941183423)
,p_template=>wwv_flow_api.id(20903049949019134)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2041788950201719)
,p_query_column_id=>1
,p_column_alias=>'ID'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(156453885690521909)
,p_query_column_id=>2
,p_column_alias=>'CSS'
,p_column_display_sequence=>2
,p_column_heading=>'Css'
,p_column_link=>'f?p=&APP_ID.:40:&SESSION.::&DEBUG.:RP:P40_CONTRACT_ID,P40_INTEGRATION_FLG,P40_SELECTED_INT_CODE:#ID#,1,#DSP_CODE#'
,p_column_linktext=>'<img src="#APP_IMAGES#sync.png" width="18px" height="18px" border="0">'
,p_derived_column=>'N'
,p_include_in_export=>'Y'
);
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(881288420088881735)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2719172050162011)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2041375599201707)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2078435245538703)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(65980396176483002)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(90139471752650613)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(90139526680650614)
,p_query_column_id=>9
...
begin
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2042197653201720)
,p_query_column_id=>10
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2078594698538704)
,p_query_column_id=>11
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2078677528538705)
,p_query_column_id=>12
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2719472408162014)
,p_query_column_id=>13
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2042544294201720)
,p_query_column_id=>14
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2079449203538713)
,p_query_column_id=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2042971859201721)
,p_query_column_id=>16
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2078366166538702)
,p_query_column_id=>17
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(421625017202942023)
,p_query_column_id=>18
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2043349104201721)
,p_query_column_id=>19
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2043730106201722)
,p_query_column_id=>20
,p_column_alias=>'ENR'
,p_column_display_sequence=>19
,p_column_heading=>'Enr'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2044184394201723)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(432912242630306230)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2044548519201723)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2044962297201724)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2045310538201728)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(432912551606306233)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2045769742201728)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2046109641201729)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2046502334201729)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2046901078201730)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2047344148201730)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(51971976247930721)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(184221641330304843)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266785607279337805)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(262513048602967304)
,p_plug_name=>'h89'
,p_parent_plug_id=>wwv_flow_api.id(187335280941183423)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(2050026183201760)
,p_name=>'Projects of  &P40_CONTRACT_DESC.'
,p_region_name=>'Projects'
,p_parent_plug_id=>wwv_flow_api.id(262513048602967304)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(271182340123315302)
,p_query_column_id=>1
,p_column_alias=>'LINK'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2050438839201761)
,p_query_column_id=>2
,p_column_alias=>'ID'
,p_column_display_sequence=>2
,p_column_heading=>'Edit'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(318511525020150804)
,p_query_column_id=>3
,p_column_alias=>'WBS'
,p_column_display_sequence=>25
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2050871722201762)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2051278311201762)
,p_query_column_id=>5
,p_column_alias=>'DSP_CODE'
,p_column_display_sequence=>5
,p_hidden_column=>'Y'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2051629435201763)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2052057503201763)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2052434610201764)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(65980403336483003)
,p_query_column_id=>9
,p_column_alias=>'APPROVAL_DATE'
,p_column_display_sequence=>18
,p_column_heading=>'Approval Date'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2052873569201765)
,p_query_column_id=>10
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2345080321116501)
,p_query_column_id=>11
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2053255018201765)
,p_query_column_id=>12
,p_column_alias=>'MODULE'
,p_column_display_sequence=>11
,p_column_heading=>'Module'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(263158411691005102)
,p_query_column_id=>13
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(263158545776005103)
,p_query_column_id=>14
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2054416451201766)
,p_query_column_id=>15
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2054814225201767)
,p_query_column_id=>16
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(263159350925005111)
,p_query_column_id=>17
,p_column_alias=>'STATUS'
,p_column_display_sequence=>20
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(266568557681915008)
,p_query_column_id=>18
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2055266619201767)
,p_query_column_id=>19
,p_column_alias=>'SEQ'
,p_column_display_sequence=>3
,p_column_heading=>'Seq'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2055699613201768)
,p_query_column_id=>20
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(432912683457306234)
,p_query_column_id=>21
,p_column_alias=>'REMAINING'
,p_column_display_sequence=>15
,p_column_heading=>'Rem.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2056097379201768)
,p_query_column_id=>22
,p_column_alias=>'WORK'
,p_column_display_sequence=>16
,p_column_heading=>'Enr.'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(2056404263201768)
,p_query_column_id=>23
,p_column_alias=>'EXPENCES'
,p_column_display_sequence=>17
,p_column_heading=>'Net'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(271182431937315303)
,p_query_column_id=>24
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(263158786474005105)
,p_query_column_id=>25
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(421625264055942025)
,p_query_column_id=>26
,p_column_alias=>'row_color'
,p_column_display_sequence=>26
,p_column_heading=>'Row color'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2078890365538707)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(2040999586201677)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(262514379558967317)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(262513048602967304)
,p_button_name=>'go'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(92535720945833603)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(187335280941183423)
,p_button_name=>'GO'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(20901145090019119)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(266567849336915001)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(262513048602967304)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(263158879326005106)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2047779389201734)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(2040999586201677)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2058475857201770)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(2050026183201760)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(20901145090019119)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2070462807201802)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(2062459578201782)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(2070874292201803)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(2062459578201782)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(2076910299201846)
...
,p_branch_when_button_id=>wwv_flow_api.id(92535720945833603)
,p_branch_sequence=>20
,p_branch_comment=>'Created 15-FEB-2011 22:33 by ADMIN'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2048850079201756)
,p_name=>'P40_CONTRACT_ID'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(2040999586201677)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2049205084201757)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2049611029201758)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2058832272201771)
,p_name=>'P40_CURRENT_PROJECT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(2050026183201760)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2059234024201772)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2059621821201776)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2071269781201803)
,p_name=>'P40_ZERO'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(2062459578201782)
,p_item_default=>'0'
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2720706447162027)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2720888526162028)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92536140058833603)
,p_name=>'P40_COMPANYNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(187335280941183423)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92536573144833607)
,p_name=>'P40_STATUS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(187335280941183423)
,p_prompt=>'Status'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92536940026833607)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92537335686833608)
,p_name=>'P40_VIEW_1'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(187335280941183423)
,p_item_default=>'non'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92537748026833608)
,p_name=>'P40_CNTIDD_1'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(187335280941183423)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92538167176833609)
,p_name=>'P40_PCI_1'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(187335280941183423)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92538544851833610)
,p_name=>'P40_CID_1'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(187335280941183423)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92538912820833610)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(156455283537521923)
...
begin
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(184221749317304844)
,p_name=>'P40_LCDID'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(2040999586201677)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262514127576967315)
,p_name=>'P40_DATE'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(262513048602967304)
,p_prompt=>'Date'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(262514463181967318)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(263158393462005101)
,p_name=>'P40_STATUS_1'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(262513048602967304)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266568219055915005)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266785705776337806)
,p_name=>'P40_CID'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(187335280941183423)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266785855439337807)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266939067274206601)
,p_name=>'P40_PCI'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(187335280941183423)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266939124383206602)
,p_name=>'P40_VIEW'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(2040999586201677)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(266939691105206607)
,p_name=>'P40_CNTIDD'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(187335280941183423)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(2079001414538709)
,p_name=>'New'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(2079199254538710)
,p_event_id=>wwv_flow_api.id(2079001414538709)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(2079237531538711)
,p_event_id=>wwv_flow_api.id(2079001414538709)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(1833549450278018)
,p_name=>'New_1'
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(2058475857201770)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(1833683723278019)
,p_event_id=>wwv_flow_api.id(1833549450278018)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(156455890858521929)
,p_name=>'loading'
,p_event_sequence=>30
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(156455909814521930)
,p_event_id=>wwv_flow_api.id(156455890858521929)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(156455369897521924)
...
'CSS_PCK.Refresh_data(:P40_SELECTED_INT_CODE); --end if;',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(2076409941201837)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(436888689090146115)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(2078890365538707)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(263851028489231003)
,p_process_sequence=>10
,p_process_point=>'ON_SUBMIT_BEFORE_COMPUTATION'
,p_process_type=>'NATIVE_PLSQL'
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(263158879326005106)
,p_process_success_message=>'success'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(266567964084915002)
...
'    P40_INTCODE VARCHAR2(200) ;',
'    P40_MODULES VARCHAR2(200)  ;',
'',
'',
' ',
'BEGIN',
...
'',
'',
'  select INT_CODE, MODULE,CONTRACT_ID into P40_INTCODE,P40_MODULES,P40_CNTID from lgs_projects where ID = C1_ID;',
...
'        l_body := l_body || ''Name: '' || P40_MODULES || '' ........... '' || ''INT_CODE: '' || P40_INTCODE || utl_tcp.crlf||utl_tcp.crlf; ',
'        ind := ind + 1;',
'    ',
