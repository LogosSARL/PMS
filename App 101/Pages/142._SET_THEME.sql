...
begin
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>142);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(291159863255660244)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(291160138061660247)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(291159863255660244)
,p_button_name=>'New'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(291160394685660249)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(291159901763660245)
,p_name=>'P142_THEME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(291159863255660244)
,p_prompt=>'Theme'
