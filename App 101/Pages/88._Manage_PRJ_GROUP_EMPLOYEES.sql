...
,p_last_upd_yyyymmddhh24miss=>'20220905085843'
);
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(6414711144920306)
,p_name=>'P88_PGE_EMP_TITLE'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(58514750423201883)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Title'
,p_source=>'PGE_EMP_TITLE'
,p_source_type=>'DB_COLUMN'
,p_display_as=>'NATIVE_SELECT_LIST'
,p_lov=>'select rol_desc val, rol_desc des from roles order by 1'
,p_cHeight=>1
,p_new_grid=>true
,p_rowspan=>2
