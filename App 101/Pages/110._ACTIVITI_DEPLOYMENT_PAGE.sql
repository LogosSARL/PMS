...
begin
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>110);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(190867412498056416)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(190867725118056419)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(193769593179297901)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(190867556606056417)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(190867412498056416)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(193770203921298008)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(193769593179297901)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190867674055056418)
,p_name=>'P110_WEBRESP'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(190867412498056416)
,p_prompt=>'Webresp'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190867883647056420)
,p_name=>'P110_DID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(190867725118056419)
,p_prompt=>' ID'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190867961146056421)
,p_name=>'P110_DNAME'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(190867725118056419)
,p_prompt=>'NAME'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190868051026056422)
,p_name=>'P110_DTIME'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(190867725118056419)
,p_prompt=>'TIME'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190868102881056423)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190868236384056424)
,p_name=>'P110_DURL'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(190867725118056419)
,p_prompt=>'URL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190868319122056425)
,p_name=>'P110_DTENANT'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(190867725118056419)
,p_prompt=>'TENANT ID'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(193769659589297902)
,p_name=>'P110_DID_1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(193769593179297901)
,p_prompt=>' ID'
,p_display_as=>'NATIVE_TEXT_FIELD'
,p_cSize=>30
,p_label_alignment=>'RIGHT-CENTER'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(193769766354297903)
,p_name=>'P110_DNAME_1'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(193769593179297901)
,p_prompt=>'NAME'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(193769806540297904)
,p_name=>'P110_DTIME_1'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(193769593179297901)
,p_prompt=>'TIME'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(193769936301297905)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(193770027943297906)
,p_name=>'P110_DURL_1'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(193769593179297901)
,p_prompt=>'URL'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(193770122670297907)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(190868436754056426)
...
,p_process_when_button_id=>wwv_flow_api.id(190867556606056417)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(193770398972298009)
...
'END;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(193770203921298008)
);
end;
/
begin
