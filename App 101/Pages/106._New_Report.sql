...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(174116934684863914)
,p_plug_name=>'New'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(174119625756863941)
,p_name=>'Report'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(174119726621863942)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(174119809396863943)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(174119902470863944)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(174120071489863945)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(174120197932863946)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(174120263102863947)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(174120380811863948)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(174120491813863949)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(174120534549863950)
,p_query_column_id=>9
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(175246604353005401)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(175246720225005402)
,p_region_id=>wwv_flow_api.id(175246604353005401)
,p_chart_type=>'pie'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(175246844140005403)
,p_chart_id=>wwv_flow_api.id(175246720225005402)
,p_seq=>10
,p_name=>'New'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(175246998369005404)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(175247003422005405)
,p_region_id=>wwv_flow_api.id(175246998369005404)
,p_chart_type=>'pie'
,p_animation_on_display=>'none'
,p_animation_on_data_change=>'none'
,p_data_cursor=>'auto'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(175247171147005406)
,p_chart_id=>wwv_flow_api.id(175247003422005405)
,p_seq=>10
,p_name=>'New'
,p_data_source_type=>'SQL_QUERY'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(349355111172534283)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(175236870607670387)
,p_region_id=>wwv_flow_api.id(349355111172534283)
,p_chart_type=>'pie'
,p_animation_on_display=>'none'
,p_animation_on_data_change=>'none'
,p_data_cursor=>'auto'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(175237359842670389)
,p_chart_id=>wwv_flow_api.id(175236870607670387)
,p_seq=>10
,p_name=>'New'
,p_data_source_type=>'SQL_QUERY'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(174118166709863926)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(174116934684863914)
,p_button_name=>'GO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(174117960541863924)
,p_name=>'P106_CONTRACT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(174116934684863914)
,p_prompt=>'Contract'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(174118037714863925)
,p_name=>'P106_PROJECT'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(174116934684863914)
,p_prompt=>'Project'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(174118274670863927)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(174118388936863928)
,p_name=>'P106_TASK'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(174116934684863914)
,p_prompt=>'Task'
