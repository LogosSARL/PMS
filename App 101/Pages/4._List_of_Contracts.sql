...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(15701801213793161)
,p_plug_name=>'Search'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(15703417763793189)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15703707702793198)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15703794712793205)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15703897750793205)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15703997486793205)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(15704104820793205)
,p_query_column_id=>5
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15702515994793180)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(15701801213793161)
,p_button_name=>'P4_GO'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(15702720880793180)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(15703315151793186)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15702100025793170)
,p_name=>'P4_REPORT_SEARCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(15701801213793161)
,p_prompt=>'Search'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(15702290389793180)
,p_name=>'P4_ROWS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(15701801213793161)
,p_item_default=>'15'
...
,p_lov=>'.'||wwv_flow_api.id(15699594006793155)||'.'
,p_cSize=>30
,p_cMaxlength=>2000
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15702915816793181)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(15703097944793186)
...
,p_process_when_button_id=>wwv_flow_api.id(15702720880793180)
);
end;
/
begin
