...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(190952849256682201)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(190952951362682202)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(190953136117682204)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(190952849256682201)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190953008252682203)
,p_name=>'P117_WEBRESP'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(190952849256682201)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190953244145682205)
,p_name=>'P117_HPIID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
,p_prompt=>'ID'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190953394228682206)
,p_name=>'P117_HPIBK'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190953459137682207)
,p_name=>'P117_HPIPDI'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190953558014682208)
,p_name=>'P117_HPIPDU'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190953670596682209)
,p_name=>'P117_HPIST'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
,p_prompt=>'START TIME'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190953722888682210)
,p_name=>'P117_HPIET'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
,p_prompt=>'END TIME'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190953831140682211)
,p_name=>'P117_HPIDIM'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190953960680682212)
,p_name=>'P117_HPISUID'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190954079237682213)
,p_name=>'P117_HPISAID'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190954138476682214)
,p_name=>'P117_HPIEAID'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190954285673682215)
,p_name=>'P117_HPIDR'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190954350032682216)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190954451466682217)
,p_name=>'P117_HPIU'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
,p_prompt=>'USER'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190954564441682218)
,p_name=>'P117_HPIV'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
,p_prompt=>'VARIABLES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(190954600090682219)
,p_name=>'P117_HPITID'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(190952951362682202)
,p_prompt=>'TENANT ID'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(190954711501682220)
...
,p_process_when_button_id=>wwv_flow_api.id(190953136117682204)
);
end;
/
begin
