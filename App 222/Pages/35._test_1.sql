...
,p_last_updated_by=>'TARIF'
,p_last_upd_yyyymmddhh24miss=>'20191007160944'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(566858573214083615)
,p_plug_name=>'New'
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(566858618560083616)
...
,p_owner=>'JAWAD'
,p_internal_uid=>566858618560083616
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(566858744586083617)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(566858840062083618)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(566858949309083619)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(566859065906083620)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(566859191929083621)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(578980892516203591)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'5789809'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
