...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(478013661571558001)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(478014050728558005)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(478013661571558001)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(478013733945558002)
,p_name=>'P8_LATITUDE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(478013661571558001)
,p_prompt=>'Latitude'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(478013898540558003)
,p_name=>'P8_LONGITUDE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(478013661571558001)
,p_prompt=>'Longitude'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(478014138187558006)
,p_name=>'New'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(478014050728558005)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(478014239954558007)
,p_event_id=>wwv_flow_api.id(478014138187558006)
,p_event_result=>'TRUE'
