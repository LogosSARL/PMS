...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(592664798477281344)
,p_plug_name=>'test'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(608544033956121401)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(592664798477281344)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(608544172637121402)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(608544510761121406)
,p_branch_action=>'f?p=&APP_ID.:102:&SESSION'
,p_branch_point=>'BEFORE_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(608544172637121402)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(592664895320281345)
,p_name=>'P102_LOGIN_ATTEMPTS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(592664798477281344)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(592664939458281346)
,p_name=>'P102_USER_PK'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(592664798477281344)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(592665044764281347)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(592665179073281348)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(592665222633281349)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(592665335121281350)
,p_name=>'P102_MESSAGE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(592664798477281344)
,p_prompt=>'Message'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(608544335513121404)
...
,p_always_execute=>'N'
,p_associated_item=>wwv_flow_api.id(592665222633281349)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(608544462331121405)
...
,p_always_execute=>'N'
,p_when_button_pressed=>wwv_flow_api.id(608544172637121402)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(608544292932121403)
