...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(478094169066530601)
,p_plug_name=>'New'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(478230537785631401)
,p_name=>'P9_REPORT_URL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(478094169066530601)
,p_prompt=>'Report url'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(478208919513166001)
,p_name=>'New'
,p_event_sequence=>10
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(478209064108166002)
,p_event_id=>wwv_flow_api.id(478208919513166001)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(478215734437313101)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(478216001679313104)
