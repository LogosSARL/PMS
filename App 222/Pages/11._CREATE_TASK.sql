...
,p_last_upd_yyyymmddhh24miss=>'20220902131415'
);
...
,p_item_plug_id=>wwv_flow_imp.id(313711810588818394)
,p_use_cache_before_default=>'NO'
,p_item_default=>'select start_date from lgs_projects where id = :p11_wbs_prj_id and :p11_wbs_id is null;'
...
,p_item_plug_id=>wwv_flow_imp.id(313711810588818394)
,p_use_cache_before_default=>'NO'
,p_item_default=>'select end_date from lgs_projects where id = :p11_wbs_prj_id and :p11_wbs_id is null;'
,p_item_default_type=>'SQL_QUERY'
,p_prompt=>'End Date'
