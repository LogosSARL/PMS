...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(798612010982179832)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(798612101507179833)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798613064919179842)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798612258291179834)
,p_db_column_name=>'ID'
,p_display_order=>20
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803408003886397412)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803408421797397416)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798613756436179849)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798613440516179846)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798613654384179848)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798613151196179843)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798613247782179844)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803410645380397438)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803410399789397435)
...
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_column_alignment=>'RIGHT'
,p_rpt_named_lov=>wwv_flow_api.id(148757821512244040)
,p_rpt_show_filter_lov=>'1'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803410527059397437)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803408199948397413)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798612981527179841)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798613538688179847)
...
,p_display_text_as=>'LOV_ESCAPE_SC'
,p_column_alignment=>'RIGHT'
,p_rpt_named_lov=>wwv_flow_api.id(148754979867244031)
,p_rpt_show_filter_lov=>'1'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803407897275397410)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803408236945397414)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803410074273397432)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798612711663179839)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803407741714397409)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798612860282179840)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798612629170179838)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803407635858397408)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803407993760397411)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803408345675397415)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798613816376179850)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803407594411397407)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803408523383397417)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803408629041397418)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803408762569397419)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803408982486397421)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803409185840397423)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803409299973397424)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803409379241397425)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803409051121397422)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803409445149397426)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798613316097179845)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803409594852397427)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803409694097397428)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803409711873397429)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803409872361397430)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803409950844397431)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803410435824397436)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803406942626397401)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803407227958397404)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803407365511397405)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803407045132397402)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803407197974397403)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803407479414397406)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803410234215397434)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803408868309397420)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798612596870179837)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803410148648397433)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798612306120179835)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(798612478387179836)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803410771342397439)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803410826567397440)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803410987543397441)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803411057082397442)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803411169607397443)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803411230311397444)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(803411399030397445)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(803442685908438724)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(803417067220402540)
,p_plug_name=>'New'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(803414710214402517)
,p_plug_name=>'General Information'
,p_region_name=>'test'
,p_parent_plug_id=>wwv_flow_api.id(803417067220402540)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(803417198591402541)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(803981293877409420)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(804110702015652324)
,p_plug_name=>'New'
,p_parent_plug_id=>wwv_flow_api.id(803417067220402540)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(804111204498652329)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(804110702015652324)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(803416950565402539)
,p_button_sequence=>150
,p_button_plug_id=>wwv_flow_api.id(803414710214402517)
,p_button_name=>'BACK'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(803416271961402532)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(803416714530402537)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(803416398480402533)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(803416403775402534)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(803416513393402535)
...
begin
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(803416845354402538)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(803413505035402405)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(798612010982179832)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(803413664235402506)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803411465647397446)
,p_name=>'P45_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(798612010982179832)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803411565857397447)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803411683013397448)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803411726258397449)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803411867995397450)
,p_name=>'P45_LCD_ID'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(798612010982179832)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803413128318402401)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803413227800402402)
,p_name=>'P45_CNTID'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(798612010982179832)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803413370908402403)
,p_name=>'P45_PCI'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(798612010982179832)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803413452177402404)
,p_name=>'P45_CID'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(798612010982179832)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803414881140402518)
,p_name=>'P45_ACCOUNT_MANAGER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(803414710214402517)
...
,p_field_template=>wwv_flow_api.id(148742491192243641)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803414971968402519)
,p_name=>'P45_DSP_CODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(803414710214402517)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803415002554402520)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803415134482402521)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803415266509402522)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803415377955402523)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803415484956402524)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803415573925402525)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803415656906402526)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803415752980402527)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803415818734402528)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803415993648402529)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803416036989402530)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803416116387402531)
,p_name=>'P45_IN_SCOPE'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(803414710214402517)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803417277694402542)
,p_name=>'P45_PRICING_DATE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(803417198591402541)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803417327121402543)
,p_name=>'P45_REF_PM'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(803417198591402541)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803417413744402544)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803417560807402545)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803417698457402546)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803417782462402547)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803417895368402548)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803981322542409421)
,p_name=>'P45_REF_TO_CONTRACT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(803981293877409420)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803981459051409422)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803981547509409423)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803981630231409424)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803981799372409425)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803981809150409426)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803981910749409427)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803982082306409428)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803982176173409429)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803982206293409430)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803983372965409441)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803983466682409442)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803983793179409445)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803984052318409448)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803984102584409449)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(803984238230409450)
,p_name=>'P45_LL_VALUE'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(803981293877409420)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804108421455652301)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804108587125652302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804108643930652303)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804108715028652304)
,p_name=>'P45_PERDIUM'
,p_item_sequence=>200
,p_item_plug_id=>wwv_flow_api.id(803981293877409420)
,p_prompt=>'Perdium'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804108897897652305)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804108952367652306)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804109038541652307)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804109149892652308)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804109263231652309)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804109371596652310)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804109418284652311)
,p_name=>'P45_REMARKS'
,p_item_sequence=>270
,p_item_plug_id=>wwv_flow_api.id(803981293877409420)
,p_prompt=>'Remarks'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804109517740652312)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804109653569652313)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804109799694652314)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804109830678652315)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804109940779652316)
,p_name=>'P45_END_DATE'
,p_item_sequence=>350
,p_item_plug_id=>wwv_flow_api.id(803981293877409420)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804110053777652317)
,p_name=>'P45_SETTLED'
,p_item_sequence=>320
,p_item_plug_id=>wwv_flow_api.id(803981293877409420)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804110136031652318)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804110253907652319)
,p_name=>'P45_STATUS'
,p_item_sequence=>340
,p_item_plug_id=>wwv_flow_api.id(803981293877409420)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804110395236652320)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804110403902652321)
...
begin
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804110500006652322)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804110667402652323)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804110872762652325)
,p_name=>'P45_RFP_FILES'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(804110702015652324)
,p_prompt=>'Rfp files'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804110954812652326)
,p_name=>'P45_RFPFILES'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(804110702015652324)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804111047147652327)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(804111123217652328)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803413772526402507)
,p_name=>'ShowAll_Clicked'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(803413664235402506)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803413842871402508)
,p_event_id=>wwv_flow_api.id(803413772526402507)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803413915791402509)
,p_event_id=>wwv_flow_api.id(803413772526402507)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803414034860402510)
,p_name=>'ColorRows'
,p_event_sequence=>20
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(798612010982179832)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803414195660402511)
,p_event_id=>wwv_flow_api.id(803414034860402510)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803979391631409401)
,p_name=>'HIDE_CNT_INF'
,p_event_sequence=>30
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803979494411409402)
,p_event_id=>wwv_flow_api.id(803979391631409401)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(803417067220402540)
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803980026679409408)
,p_event_id=>wwv_flow_api.id(803979391631409401)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803980307473409411)
,p_name=>'CNT_PICKED'
,p_event_sequence=>40
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803980512005409413)
,p_event_id=>wwv_flow_api.id(803980307473409411)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803980482968409412)
,p_event_id=>wwv_flow_api.id(803980307473409411)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803980646298409414)
,p_name=>'CLEAR_ID'
,p_event_sequence=>50
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(803416950565402539)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803980769577409415)
,p_event_id=>wwv_flow_api.id(803980646298409414)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803981072843409418)
,p_event_id=>wwv_flow_api.id(803980646298409414)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803981193673409419)
,p_event_id=>wwv_flow_api.id(803980646298409414)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803982344942409431)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803982478526409432)
,p_event_id=>wwv_flow_api.id(803982344942409431)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803982573527409433)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803982634361409434)
,p_event_id=>wwv_flow_api.id(803982573527409433)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803982728693409435)
,p_name=>'OL-CHANGED'
,p_event_sequence=>80
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803982820468409436)
,p_event_id=>wwv_flow_api.id(803982728693409435)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803982955787409437)
,p_name=>'AL_CHANGED'
,p_event_sequence=>90
,p_triggering_element_type=>'ITEM'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803983056413409438)
,p_event_id=>wwv_flow_api.id(803982955787409437)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803983158696409439)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803983221701409440)
,p_event_id=>wwv_flow_api.id(803983158696409439)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803983549330409443)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803983600739409444)
,p_event_id=>wwv_flow_api.id(803983549330409443)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(803983853739409446)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(803983913289409447)
,p_event_id=>wwv_flow_api.id(803983853739409446)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(804111915502652336)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804112097633652337)
,p_event_id=>wwv_flow_api.id(804111915502652336)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(803416271961402532)
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804112340647652340)
,p_event_id=>wwv_flow_api.id(804111915502652336)
...
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(803416398480402533)
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804112127546652338)
,p_event_id=>wwv_flow_api.id(804111915502652336)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(803416714530402537)
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804112458136652341)
,p_event_id=>wwv_flow_api.id(804111915502652336)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804112213635652339)
,p_event_id=>wwv_flow_api.id(804111915502652336)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804112536506652342)
,p_event_id=>wwv_flow_api.id(804111915502652336)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(804112602010652343)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804112751000652344)
,p_event_id=>wwv_flow_api.id(804112602010652343)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(803416513393402535)
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804113033115652347)
,p_event_id=>wwv_flow_api.id(804112602010652343)
,p_event_result=>'FALSE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_HIDE'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(803416403775402534)
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804112854479652345)
,p_event_id=>wwv_flow_api.id(804112602010652343)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804113172634652348)
,p_event_id=>wwv_flow_api.id(804112602010652343)
,p_event_result=>'FALSE'
,p_action_sequence=>20
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804112930715652346)
,p_event_id=>wwv_flow_api.id(804112602010652343)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SHOW'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_api.id(803416845354402538)
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804113293106652349)
,p_event_id=>wwv_flow_api.id(804112602010652343)
,p_event_result=>'FALSE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(804113324794652350)
,p_name=>'CREATE_PIPELINE'
,p_event_sequence=>150
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(803413505035402405)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804213851957693904)
,p_event_id=>wwv_flow_api.id(804113324794652350)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804213553406693901)
,p_event_id=>wwv_flow_api.id(804113324794652350)
,p_event_result=>'TRUE'
,p_action_sequence=>30
,p_execute_on_page_init=>'Y'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804214032134693906)
,p_event_id=>wwv_flow_api.id(804113324794652350)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(804214216694693908)
,p_name=>'AUTO_DML'
,p_event_sequence=>160
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(803416271961402532)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(804214326085693909)
,p_event_id=>wwv_flow_api.id(804214216694693908)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(804111719646652334)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(804214429935693910)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(804214523119693911)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(804214724091693913)
