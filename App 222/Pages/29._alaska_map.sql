...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(478256733839529461)
...
wwv_flow_api.create_flash_chart5(
 p_id=>wwv_flow_api.id(478257101516529461)
,p_default_chart_type=>'Map'
,p_chart_title=>'alaska'
,p_chart_rendering=>'FLASH_PREFERRED'
,p_chart_name=>'chart_478257101516529461'
,p_chart_width=>700
,p_chart_height=>500
,p_chart_animation=>'N'
...
,p_map_source=>'usa/states/counties/ak.amap'
...
wwv_flow_api.create_flash_chart5_series(
 p_id=>wwv_flow_api.id(478257590587529461)
,p_chart_id=>wwv_flow_api.id(478257101516529461)
,p_series_seq=>10
