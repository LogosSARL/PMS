...
begin
wwv_flow_api.remove_page (p_flow_id=>wwv_flow.g_flow_id, p_page_id=>46);
end;
/
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(877314142956390736)
,p_plug_name=>'New'
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(877314237411390737)
,p_region_id=>wwv_flow_api.id(877314142956390736)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(877315184840390746)
,p_chart_id=>wwv_flow_api.id(877314237411390737)
,p_seq=>90
,p_name=>'ADM'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(881285341514881704)
,p_chart_id=>wwv_flow_api.id(877314237411390737)
,p_seq=>100
,p_name=>'SUP'
,p_data_source_type=>'SQL_QUERY'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(881285411434881705)
,p_chart_id=>wwv_flow_api.id(877314237411390737)
,p_seq=>110
,p_name=>'IMP'
,p_data_source_type=>'SQL_QUERY'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(881285564078881706)
,p_chart_id=>wwv_flow_api.id(877314237411390737)
,p_seq=>120
,p_name=>'DEV'
,p_data_source_type=>'SQL_QUERY'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(881285654795881707)
,p_chart_id=>wwv_flow_api.id(877314237411390737)
,p_seq=>130
,p_name=>'TRA'
,p_data_source_type=>'SQL_QUERY'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(881285796553881708)
,p_chart_id=>wwv_flow_api.id(877314237411390737)
,p_seq=>140
,p_name=>'OTH'
,p_data_source_type=>'SQL_QUERY'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(881285118961881702)
,p_chart_id=>wwv_flow_api.id(877314237411390737)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(881285216345881703)
,p_chart_id=>wwv_flow_api.id(877314237411390737)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(881202760576680710)
,p_plug_name=>'New'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(901731311007000801)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(901731472629000802)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(901731643751000804)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(901731788203000805)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(901731841410000806)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(901731973147000807)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(901738081510039829)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(901732059944000808)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(148719512587243497)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(901732181343000809)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(901732422382000812)
,p_db_column_name=>'PERSONNEL_CODE'
,p_display_order=>30
,p_column_identifier=>'C'
,p_column_label=>'Personnel code'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(901732595680000813)
,p_db_column_name=>'VALUE'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Value'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(901732895901000816)
,p_db_column_name=>'CUSTOMER_CODE'
,p_display_order=>50
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(901732995736000817)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(881286504695881716)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(881286697503881717)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(901742305288113518)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_worksheet_group_by(
 p_id=>wwv_flow_api.id(983313687478777681)
,p_report_id=>wwv_flow_api.id(901742305288113518)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(901776268705005801)
,p_plug_name=>'New'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(148719512587243497)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(901776341684005802)
,p_max_row_count=>'1000000'
,p_show_nulls_as=>'-'
,p_pagination_type=>'ROWS_X_TO_Y'
,p_pagination_display_pos=>'BOTTOM_RIGHT'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(901776447492005803)
,p_db_column_name=>'PERSONNEL_CODE'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Personnel code'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(901776532601005804)
,p_db_column_name=>'VALUE'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Value'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(901776895865005807)
,p_db_column_name=>'LABEL'
,p_display_order=>40
,p_column_identifier=>'D'
,p_column_label=>'Label'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(881285879173881709)
,p_db_column_name=>'CUSTOMER_CODE'
,p_display_order=>50
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(901782973613012377)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(881202659542680709)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_api.id(881202760576680710)
,p_button_name=>'Go'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(881202320199680706)
,p_name=>'P46_CUSTOMER'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(881202760576680710)
,p_prompt=>'Customer'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(881202834354680711)
,p_name=>'P46_EMPLOYEE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(881202760576680710)
,p_prompt=>'Employee'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(881285915676881710)
,p_name=>'P46_FD'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(881202760576680710)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(881286049069881711)
,p_name=>'P46_TD'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(881202760576680710)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(881202476973680707)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(881202515274680708)
,p_event_id=>wwv_flow_api.id(881202476973680707)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(877314142956390736)
);
end;
/
begin
