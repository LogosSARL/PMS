...
,p_step_sub_title=>'Remaining Effort'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(724553421044242833)
,p_plug_name=>'New'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(724554880296242847)
,p_plug_name=>'Summary'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(724554937734242848)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(724555033490242849)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(724555131296242850)
,p_db_column_name=>'ID'
,p_display_order=>20
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374089599230945201)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374089662245945202)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374089796320945203)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374089891814945204)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374089905033945205)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374090044386945206)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374090195047945207)
,p_db_column_name=>'WN'
,p_display_order=>90
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374090220358945208)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374090329118945209)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374090557108945211)
,p_db_column_name=>'PR'
,p_display_order=>120
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374090831133945214)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(1374098339643948996)
...
wwv_flow_api.create_worksheet_group_by(
 p_id=>wwv_flow_api.id(1383009998393238810)
,p_report_id=>wwv_flow_api.id(1374098339643948996)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1286501697374642997)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(1286502121458643000)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(1286502267947643000)
,p_name=>'Remaining Effort'
,p_max_row_count=>'1000000'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1286502689055643012)
,p_db_column_name=>'WORK_TYPE'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Work Type'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1286503446033643015)
,p_db_column_name=>'ESTIMATED'
,p_display_order=>3
,p_column_identifier=>'C'
,p_column_label=>'Estimated'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1286503892227643015)
,p_db_column_name=>'ENROLLMENT'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Enrollment'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1286504275513643015)
,p_db_column_name=>'REMAINING'
,p_display_order=>5
,p_column_identifier=>'E'
,p_column_label=>'Remaining'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1286504650883643016)
,p_db_column_name=>'WORKNEEDED'
,p_display_order=>6
,p_column_identifier=>'F'
,p_column_label=>'Workneeded'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1286505010485643016)
,p_db_column_name=>'WN'
,p_display_order=>7
,p_column_identifier=>'G'
,p_column_label=>'Wn'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1286505436143643016)
,p_db_column_name=>'SYSTEM_REMAINING'
,p_display_order=>8
,p_column_identifier=>'H'
,p_column_label=>'System Remaining'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(881288099267881731)
,p_db_column_name=>'DSP_CODE'
,p_display_order=>18
,p_column_identifier=>'I'
,p_column_label=>'Dsp code'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(724554567542242844)
,p_db_column_name=>'ID'
,p_display_order=>28
,p_column_identifier=>'J'
,p_column_label=>'Id'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(724554721911242846)
,p_db_column_name=>'TASK'
,p_display_order=>38
,p_column_identifier=>'L'
,p_column_label=>'Task'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374090410784945210)
,p_db_column_name=>'PR'
,p_display_order=>48
,p_column_identifier=>'M'
,p_column_label=>'Pr'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374090653619945212)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374090780654945213)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(1374090976122945215)
,p_db_column_name=>'MAN'
,p_display_order=>78
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(1286506018585644416)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_type=>'PIVOT'
...
wwv_flow_api.create_worksheet_pivot(
 p_id=>wwv_flow_api.id(1387793720044648979)
,p_report_id=>wwv_flow_api.id(1286506018585644416)
,p_pivot_columns=>'WORK_TYPE'
,p_row_columns=>'DSP_CODE:DESCRIPTION:CHILDREN'
);
wwv_flow_api.create_worksheet_pivot_agg(
 p_id=>wwv_flow_api.id(1387794137934648980)
,p_pivot_id=>wwv_flow_api.id(1387793720044648979)
,p_display_seq=>1
,p_function_name=>'SUM'
...
wwv_flow_api.create_worksheet_pivot_agg(
 p_id=>wwv_flow_api.id(1387794517334648980)
,p_pivot_id=>wwv_flow_api.id(1387793720044648979)
,p_display_seq=>2
,p_function_name=>'SUM'
...
wwv_flow_api.create_worksheet_pivot_agg(
 p_id=>wwv_flow_api.id(1387794922281648980)
,p_pivot_id=>wwv_flow_api.id(1387793720044648979)
,p_display_seq=>3
,p_function_name=>'SUM'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(724553886167242837)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(724553421044242833)
,p_button_name=>'Go'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(724553395398242832)
,p_name=>'P48_BUS_TYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(724553421044242833)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(724553908082242838)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1374091067886945216)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(1374091267391945218)
,p_name=>'P48_MNT'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(724553421044242833)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(724554071633242839)
,p_name=>'New'
,p_event_sequence=>10
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(724554177988242840)
,p_event_id=>wwv_flow_api.id(724554071633242839)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(724554218581242841)
,p_event_id=>wwv_flow_api.id(724554071633242839)
,p_event_result=>'TRUE'
